...
const ProductDetails = () => {
  ...
  if (isloading) {
    return <div className="flex justifycontainer flex-wrap loadingProduct">
  ...
  return (
    <section className="text-gray-600 body-font overflow-hidden">
      ...
      {
        alert ? 
        <Alert msg="Product is added to the cart."/> : <></>
      }
      </div>
          ...
          <div className="lg:w-1/2 w-full lg:pl-10  mt-6 lg:mt-0">
            ...
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="text-gray-600 ml-3 text-xl">{product.rating.rate}</span>
              </span>
